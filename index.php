...
<html lang="fr">
	<head>
		...
		<script src="main.js"></script>
	  	<title>Wacheux Fabien - Web Developer & Manager</title>
	</head>
	<body>
		<div id="wrapper">
		  	<div id="content">
		    	<div id="card">
		      		<div id="front">
		        		...
		        		<div id="info-box">
		          			<div class="info">
		            			<h1>Fabien Wacheux</h1>
		            			<h2>Web Developer & Manager</h2>
		          			</div>
		        		</div>
		        		<div id="social-bar">
						  	...
						  	<a href="https://twitter.com/fabienwacheux" target="_blank">
						  		<i class="fa fa-twitter"></i>
						  	</a>
						  	<a href="https://github.com/fabwach" target="_blank">
